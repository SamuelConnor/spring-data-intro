...
public class CustomerService {
    ...
    public CustomerEntity findCustomerById(Long Id) {
        return customerEntityRepository.findById(Id).orElseThrow(CustomerNotFoundException::new);
    }
    ...
    public CustomerEntity updateCustomer(CustomerEntity newCustomer, Long id) {
       CustomerEntity customer = customerEntityRepository.findById(id).orElseThrow(CustomerNotFoundException::new);
